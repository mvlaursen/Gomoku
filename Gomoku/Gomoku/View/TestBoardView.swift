    ...
    override func draw(_ rect: CGRect) {
        ...
        for row in Board.lowerBound..<Board.lowerBound + GameConfiguration.squaresPerDim {
            for col in Board.lowerBound..<Board.lowerBound + GameConfiguration.squaresPerDim {
                ...
                case Square.black: drawStone(squareDim: squareDim, color: UIColor.black, row: row, col: col)
                case Square.white: drawStone(squareDim: squareDim, color: UIColor.lightGray, row: row, col: col)
                default: break
                }
            }
        }
